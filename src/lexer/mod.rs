...
mod tests {
    ...
    fn test_no_paren() {
        ...
        let variable_result: VecDeque<Exp> = vec![
            Exp::Variable("a".to_owned()),
    ...
    fn test_paren() {
        ...
        let operator_result: VecDeque<String> =
            vec!["(", "+", "(", "-", ")", "+", "(", "*", ")", ")"]
                .into_iter()
                .rev()
                .map(|s| s.to_owned())
    ...
    fn test_strings() {
        ...
        let variable_result: VecDeque<Exp> = vec![
            Exp::Lit(Lit::Str("Hello world1234 + ".to_owned())),
